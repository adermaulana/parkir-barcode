...
//menampilkan data edit di halaman edit
if(isset($_GET['hal'])){
    if($_GET['hal'] == "edit"){
        $tampil = mysqli_query($koneksi, "SELECT * FROM kendaraan WHERE id = '$_GET[id]'");
...
//fungsi untuk melakukan edit data ke dalam database
if (isset($_POST['simpan'])) {
    // Update data pelanggan
    $simpan = mysqli_query($koneksi, "UPDATE kendaraan SET
              ...
              <form method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="tipe_kendaraan" class="form-control" id="exampleInputEmail1" value="<?= $tipe_kendaraan ?>" placeholder="Enter Tipe Kendaraan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Harga/Jam</label>
                    <input type="number" name="harga" class="form-control" id="exampleInputPassword1" value="<?= $harga ?>" placeholder="Harga">
                  </div>
                </div>
                <!-- /.card-body -->
